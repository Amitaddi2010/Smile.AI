...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex bg-white font-sans selection:bg-blue-600/10">
                ...
                <div className="relative z-20 w-full mb-10">
                    <div className="rounded-[2rem] bg-white/10 border border-white/20 backdrop-blur-2xl p-8 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)] hover:bg-white/[0.12] transition-all duration-500 group">
                        ...
                        <h2 className="text-3xl font-bold text-white mb-4 leading-tight">
                            Contextual AI<br />for mental wellness.
                        </h2>
                        <p className="text-white/80 text-sm leading-relaxed font-light">
                            SMILE evaluates lifestyle and behavioral patterns instantly, providing actionable, private insights without compromising your data.
                        </p>
                        ...
                        <div className="mt-8 flex items-center gap-3">
                            ...
                            <p className="text-xs text-white/70 font-medium">Join 100k+ students</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex-1 flex flex-col justify-center px-6 py-12 sm:px-16 lg:px-24 relative xl:px-36">

                {/* Back button */}
                <Link href="/" className="absolute top-8 left-8 sm:top-12 sm:left-12 inline-flex items-center gap-2 text-sm font-semibold text-slate-400 hover:text-slate-900 transition-colors group">
                ...
                <div className="w-full max-w-sm mx-auto">
                    ...
                    <div className="mb-10">
                        ...
                        <p className="text-slate-500 text-sm sm:text-base">Please enter your details to sign in.</p>
                    </div>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-sm text-slate-500 font-medium">
                            ...
                            <Link href="/signup" className="text-slate-900 font-bold hover:text-blue-600 transition-colors underline decoration-slate-300 underline-offset-4 hover:decoration-blue-600">
                                Create an account
                            </Link>
                        </p>
                    </div>
