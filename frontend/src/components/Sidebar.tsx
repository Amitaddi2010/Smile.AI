...
import {
    ...
    Menu, X, Shield, FileText, Sparkles
} from 'lucide-react';
            ...
            >
                ...
                <div className="p-3 border-t border-[#f1f5f9] bg-[#f8fafc]/50">
                    <div className={`flex items-center ${collapsed && !isOpen ? 'justify-center' : 'gap-3 px-3'} py-3`}>
                        ...
                        {(!collapsed || isOpen) && (
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-[10px] text-[#94a3b8] uppercase tracking-wider font-bold flex items-center gap-1.5 mt-0.5">
                    ...
                    <button
                        ...
                        className={`flex items-center gap-3 w-full px-3 py-2.5 rounded-xl text-[#94a3b8] hover:text-red-600 hover:bg-red-50 transition-all group font-medium ${collapsed && !isOpen ? 'justify-center' : ''}`}
                    >
